...
static uint8_t const hid_only_config[] = {
    TUD_CONFIG_DESCRIPTOR(1, 1, 0, TUD_CONFIG_DESC_LEN + TUD_HID_INOUT_DESC_LEN, 0, 50),
    TUD_HID_INOUT_DESCRIPTOR(ITF_HID, 0, true, sizeof(desc_hid_report),
...
static uint8_t const cdc_msc_config[] = {
    TUD_CONFIG_DESCRIPTOR(1, CDCMSC_MAX, 0,
        TUD_CONFIG_DESC_LEN + TUD_CDC_DESC_LEN + TUD_MSC_DESC_LEN, 0, 50),
    TUD_CDC_DESCRIPTOR(ITF_CDC, 0, EPNUM_CDC_NOTIF, 8, EPNUM_CDC_OUT, EPNUM_CDC_IN, 64),
